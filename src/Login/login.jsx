...
const LoginPage = ({ onLogin }) => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Chame a função onLogin para passar os dados do usuário para o App
            if (onLogin) {
                onLogin(response);
            }
    ...
    return (
        <div className="login-container">
            ...
            <div className="social-icons">
                <img src={iconapple } alt="Apple Logo" className="apple-icon" />
                <img src={icongoogle} alt="Google Logo" className="google-icon" />
                <img src={iconface} alt="Facebook Logo" className="facebook-icon" />
            </div>
        </div>
    );
};
